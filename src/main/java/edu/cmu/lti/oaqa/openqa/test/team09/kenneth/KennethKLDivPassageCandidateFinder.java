...
public class KennethKLDivPassageCandidateFinder {
	...
	private KeytermWindowScorerKennethKLDiv scorer;
	
	public KennethKLDivPassageCandidateFinder( String docId , String text , KeytermWindowScorerKennethKLDiv scorer ) {
		super();
		this.text = text;
		this.docId = docId;
	...
	public List<PassageCandidate> extractPassages( String[] keyterms ) {
		...
		for ( Integer begin : leftEdges ) {
			for ( Integer end : rightEdges ) {
				...
				double score = scorer.getKLDiv(wordArray, keyterms);
